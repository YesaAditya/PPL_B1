...
<div class="container mx-auto px-4 py-6 max-w-6xl">
    <div class="flex items-center justify-between mb-8">
        <h2 class="text-2xl font-bold text-gray-800">Notifikasi Sistem</h2>
    ...
    <div class="mb-10">
        <div class="flex items-center mb-4">
            <h4 class="text-lg font-semibold text-gray-700">Notifikasi Baru</h4>
            ...
            <div class="p-4 flex justify-between items-start">
                <a href="{{ route('notifikasi.lihat', $notif->id) }}" class="flex-1 group">
                    ...
                    <div class="flex items-center mt-1 space-x-3">
                        ...
                        <span class="text-xs bg-gray-100 text-gray-600 px-2 py-0.5 rounded">Transaksi #{{ $notif->transaksi_id }}</span>
                        @endif
                    </div>
                </a>
    ...
    <!-- Read Notifications -->
    <div>
        <h4 class="text-lg font-semibold text-gray-700 mb-4">Riwayat Notifikasi</h4>

        @forelse ($notifikasiSudahDibaca as $notif)
        <div class="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow mb-3">
            <a href="{{ route('ShowDetailTransaksi', $notif->transaksi_id) }}" class="block p-4 group">
                ...
                <div class="flex items-center mt-1 space-x-3">
                    ...
                    @if($notif->transaksi_id)
                    <span class="text-xs bg-gray-100 text-gray-500 px-2 py-0.5 rounded">Transaksi #{{ $notif->transaksi_id }}</span>
                    @endif
                </div>
            </a>
        </div>
